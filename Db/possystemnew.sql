...
--
ALTER TABLE `returnproduct`
  ADD CONSTRAINT `returnproduct_ibfk_2` FOREIGN KEY (`invoiceProductId`) REFERENCES `invoiceproduct` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `returnproduct_ibfk_3` FOREIGN KEY (`returnItemId`) REFERENCES `returnitems` (`returnItemId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `returnproduct_ibfk_4` FOREIGN KEY (`stockId`) REFERENCES `stock` (`stockId`) ON DELETE NO ACTION ON UPDATE NO ACTION;
